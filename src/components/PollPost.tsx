...
const testpollpost: IPollPost = {
    username: "Omzy",
    text: "Does your cultural upbringing influence your big life decisions?",
    likeCount: 0,
    forwardCount: 0,
    options: [
        {
...
const PollPost: React.FC = () => {
    const [likeCount, setlikeCount] = useState(testpollpost.likeCount);
    const [forwardCount, setforwardCount] = useState(testpollpost.forwardCount);

    const addLike = () => {
        setlikeCount(likeCount + 1)
        testpollpost.likeCount++
    }
                            ...
                            <div className="flex justify-start items-center self-stretch gap-6">
                                <div className="flex justify-start items-center flex-grow gap-4">
                                    <div className="flex justify-start items-center relative gap-1 p-0.5">
                                        ...
                                        <p className="text-xs text-left text-[#545454]">{testpollpost.likeCount}</p>
                                    </div>
                                ...
                                <div className="flex justify-end items-center flex-grow relative gap-1 p-0.5">
                                    ...
                                    <p className="text-xs text-left text-[#545454]">{testpollpost.forwardCount}</p>
                                </div>
                            </div>
                        </div>
                    </div>
